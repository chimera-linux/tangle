...
static _Thread_local sd_bus *default_system_bus = NULL;
static _Thread_local sd_bus *default_user_bus = NULL;
static _Thread_local sd_bus *default_starter_bus = NULL;
